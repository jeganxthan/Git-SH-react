...
const SignUp = () => {
  ...
  return (
    <div className="max-w-md mx-auto mt-10 p-6 border bg-white text-black rounded-2xl">
      ...
      <div className='flex flex-row space-x-4 mt-2'>
        ...
        <button
          onClick={googleAuth}
          className="w-full bg-white text-black p-2 rounded-xl border hover:bg-slate-400 hover:cursor-pointer"
        >
        ...
        <button className="w-full bg-white text-black p-2 rounded-xl border hover:bg-slate-400 hover:cursor-pointer" onClick={githubAuth} ><div className='flex flex-row items-center justify-center'>
